...
void Shader::setVec2fv(const std::string& name, int NumOfVec2, glm::vec2& first_vec2, bool useShader)
{
	if (useShader)
		this->use();
	glUniform2fv(glGetUniformLocation(ID, name.c_str()), NumOfVec2, &first_vec2[0]);
}
...
void Shader::setVec3fv(const std::string& name, int NumOfVec3, const glm::vec3& first_vec3, bool useShader)
{
	if (useShader)
		this->use();
	glUniform3fv(glGetUniformLocation(ID, name.c_str()), NumOfVec3, &first_vec3[0]);
}
...
void Shader::setVec4fv(const std::string& name, int NumOfVec4, const glm::vec4& first_vec4, bool useShader)
{
	if (useShader)
		this->use();
	glUniform4fv(glGetUniformLocation(ID, name.c_str()), NumOfVec4, &first_vec4[0]);
}
...
void Shader::setMat4fv(const std::string& name, GLsizei NumOfMat, glm::mat4& mat, GLboolean IfTranspose, bool useShader)
{
	if (useShader)
		this->use();
	glUniformMatrix4fv(glGetUniformLocation(ID, name.c_str()), NumOfMat, IfTranspose, glm::value_ptr(mat));
}
...
{
	glUniform3fv(glGetUniformLocation(ID, name.c_str()), NumOfVec3, &value[0]);
}
// ------------------------------------------------------------------------
