...
//着色器文件路径
const char* PBR_vsPath = "E:/Learn/Deps/GLSL/6_PBR/3/1/vPbrShader.vs";
const char* PBR_fsPath = "E:/Learn/Deps/GLSL/6_PBR/3/1/fPbrShader.fs";
const char* PBRMAP_fsPath = "E:/Learn/Deps/GLSL/6_PBR/3/1/fPbrMapShader.fs";
const char* L_vsPath = "E:/Learn/Deps/GLSL/6_PBR/3/1/vLightShader.vs";
const char* L_fsPath = "E:/Learn/Deps/GLSL/6_PBR/3/1/fLightShader.fs";
const char* C_vsPath = "E:/Learn/Deps/GLSL/6_PBR/3/1/vERtoCubeMapShader.vs";
const char* C_fsPath = "E:/Learn/Deps/GLSL/6_PBR/3/1/fERtoCubeMapShader.fs";
const char* B_vsPath = "E:/Learn/Deps/GLSL/6_PBR/3/1/vBackgroundShader.vs";
const char* B_fsPath = "E:/Learn/Deps/GLSL/6_PBR/3/1/fBackgroundShader.fs";
const char* I_fsPath = "E:/Learn/Deps/GLSL/6_PBR/3/1/fIrradianceShader.fs";
...
int main()
{
	...
	Shader equirectangularToCubemapShader(C_vsPath, C_fsPath);
	Shader irradianceShader(C_vsPath, I_fsPath);
	Shader backgroundShader(B_vsPath, B_fsPath);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		float spacing = 2.5;
		glActiveTexture(GL_TEXTURE0);
		glBindTexture(GL_TEXTURE_CUBE_MAP, irradianceMap); //绑定预计算完成的IBL贴图
