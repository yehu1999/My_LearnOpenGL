...
//着色器文件路径
const char* vsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/7/vShader.vs";
const char* fsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/7/fShader.fs";
const char* HB_vsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/7/vHdrBloomShader.vs";
const char* HB_fsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/7/fHdrBloomShader.fs";
const char* B_vsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/7/vBlurShader.vs";
const char* B_fsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/7/fBlurShader.fs";
const char* L_vsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/7/vLightShader.vs";
const char* L_fsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/7/fLightShader.fs";

//摄像机
Camera camera(glm::vec3(0.0f, 0.0f, 7.0f));//相机初始位置
...
int main()
{
	...
	Shader hdrBloomShader(HB_vsPath, HB_fsPath);
	Shader blurShader(B_vsPath, B_fsPath);
	...
	//告诉OpenGL这个帧缓冲将使用多个颜色附件来进行渲染(多渲染目标)
	...
	hdrBloomShader.use();
	hdrBloomShader.setTex("scene", 0);
	hdrBloomShader.setTex("bloomBlur", 1);
	blurShader.use();
	blurShader.setTex("image", 0);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//3.绘制屏幕，将HDR的结果色调映射到默认帧缓冲
		glViewport(0, 0, SCR_WIDTH, SCR_HEIGHT);  //默认视口
		...
		hdrBloomShader.setInt("bloom", bloom);
