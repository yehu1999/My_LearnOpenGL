...
//着色器文件路径
const char* vsPath =   "E:/Learn/Deps/GLSL/5_AdvancedLighting/6/vShader.vs";
const char* fsPath =   "E:/Learn/Deps/GLSL/5_AdvancedLighting/6/fShader.fs";
const char* H_vsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/6/vHDRShader.vs";
const char* H_fsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/6/fHDRShader.fs";

//摄像机
Camera camera(glm::vec3(0.0f, 0.0f, 1.0f));//相机初始位置
...
int main()
{
	...
	Shader hdrShader(H_vsPath, H_fsPath);
