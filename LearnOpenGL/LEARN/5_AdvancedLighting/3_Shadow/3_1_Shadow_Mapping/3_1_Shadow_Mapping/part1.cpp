...
const char* Q_vsPath =   "E:/Learn/Deps/GLSL/5_AdvancedLighting/3/3_1/vQuadShader.vs";
const char* Q_fsPath =   "E:/Learn/Deps/GLSL/5_AdvancedLighting/3/3_1/fQuadShader.fs";
const char* D_vsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/3/3_1/vDepthShader.vs";
const char* D_fsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/3/3_1/fDepthShader.fs";
...
int main()
{
	...
	Shader DepthShader(D_vsPath, D_fsPath);
	...
	// load textures
	unsigned int woodTexture = loadTexture("E:/Learn/Deps/Sources/textures/wood.png", false);
