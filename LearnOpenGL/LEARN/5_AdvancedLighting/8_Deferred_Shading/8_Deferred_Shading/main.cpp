...
//着色器文件路径
const char* GP_vsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/8/vGeometryPassShader.vs";
const char* GP_fsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/8/fGeometryPassShader.fs";
const char* LP_vsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/8/vLightingPassShader.vs";
const char* LP_fsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/8/fLightingPassShader.fs";
const char* L_vsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/8/vLightShader.vs";
const char* L_fsPath = "E:/Learn/Deps/GLSL/5_AdvancedLighting/8/fLightShader.fs";
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		*/
		...
		//DEBUG （见INPractice章节）
		DisplayFramebufferTexture(debugShader, gNormal);
