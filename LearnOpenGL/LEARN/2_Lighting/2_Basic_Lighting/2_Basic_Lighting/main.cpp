...
const char* vsPath = "E:\\Learn\\Deps\\GLSL\\2_Lighting\\2\\vShader.vs";
const char* fsPath = "E:\\Learn\\Deps\\GLSL\\2_Lighting\\2\\fShader.fs";
const char* L_vsPath = "E:\\Learn\\Deps\\GLSL\\2_Lighting\\2\\vLightShader.vs";
const char* L_fsPath = "E:\\Learn\\Deps\\GLSL\\2_Lighting\\2\\fLightShader.fs";
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		shader.use();
		//设置物体颜色与光照颜色
		shader.setVec3("objectColor", 1.0f, 0.8745f, 0.31f);//金色
