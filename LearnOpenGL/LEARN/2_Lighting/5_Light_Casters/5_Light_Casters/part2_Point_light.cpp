...
const char* vsPath = "E:\\Learn\\Deps\\GLSL\\2_Lighting\\5\\vShader2.vs";
const char* fsPath = "E:\\Learn\\Deps\\GLSL\\2_Lighting\\5\\fShader2.fs";
const char* L_vsPath = "E:\\Learn\\Deps\\GLSL\\2_Lighting\\5\\vLightShader2.vs";
const char* L_fsPath = "E:\\Learn\\Deps\\GLSL\\2_Lighting\\5\\fLightShader2.fs";
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::vec3 ambientColor = diffuseColor * glm::vec3(0.2f); //这个vec3的作用相当于光照强度
